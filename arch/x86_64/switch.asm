...
yield_task:
    ...
    lea rdi, [rsp + 8]       ; pass frame pointer (skip alignment padding)
    call yield_handler_c
    add rsp, 8               ; remove alignment padding
    ; If yield_handler returns (no other task), clean up and return
    mov rax, [rsp + 144]     ; get saved rip (return address) from frame
